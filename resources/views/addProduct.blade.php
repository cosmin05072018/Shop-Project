        ...
        <div class="card border-0 mt-3">
            <div class="card-body">
                <div class="card border-0">
                    <div class="card-body">
                        <form action="{{ route('addProductDataBase') }}" method="POST" enctype="multipart/form-data" class="p-5 rounded">
                            @csrf
                            ...
                            <div class="form-group row d-flex align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="Title" value="{{ old('title') }}" name="title" placeholder="Enter Title Food">
                                    @error('title')
                            ...
                            <div class="form-group row mt-5 d-flex align-items-center">
                                <label for="Description" class="col-sm-2 col-form-label text-center">
                            ...
                            <div class="form-group row mt-5 d-flex align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" value="{{ old('price') }}" name="price" id="Price" placeholder="Enter Price Food">
                                    @error('price')
                                    <div class="mt-1 w-100 text-center">
                                        <b>{{ $message }}</b>
                                    </div>
                            ...
                            <div class="form-group row mt-5 d-flex align-items-center">
                                <label for="Category" class="col-sm-2 col-form-label text-center">
                            ...
                            <div class="form-group row mt-5 d-flex align-items-center">
                                <label for="Image" class="col-sm-2 col-form-label text-center">
