                ...
                <div>
                    <nav class="navbar ">
                        <div class="container-fluid  border border-3 rounded mb-2">
                            <a class="navbar-brand d-flex align-items-center justify-content-between w-100"
                        ...
                        <div
                            class="container-fluid border border-3 rounded mb-2">
                ...
                <div class="mt-5">
                    ...
                    <form action="{{ route('viewProducts') }}" method="get" class="mt-3">
                        ...
                        <select name="category_filter" id="category_filter" class="form-select">
                            <option value="all" {{ request('category_filter', 'all') == 'all' ? 'selected' : '' }}>All
                                Categories ({{$totalProducts}})
                            </option>
                            @foreach ($categories as $category)
                                <option
                                    value="{{ $category['category'] }}" {{ request('category_filter') == $category['category'] ? 'selected' : '' }}>{{ $category['category'] }}
                        ...
                        <div class="range-slider">
                            ...
                            <input type="range" class="min-price" name="minValue" value="{{ $priceRange[0] }}"
                                   min="{{ $priceRange[0] }}" max="{{ $priceRange[1] }}"/>
                            <input type="range" class="max-price" name="maxValue" value="{{ $priceRange[1] }}"
                                   min="{{ $priceRange[0] }}" max="{{ $priceRange[1] }}"/>
                        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-around align-items-center">
                            <button class="btn btn-primary w-25"><a
                                    href="{{ route('detailsProduct', $product->id) }}"
                            ...
                            <button type="button"
                                    class="btn btn-danger w-25 d-flex align-items-center justify-content-between"
